...
function initializeSeedData() {
  ...
  const estatePartner: PartnerProfile = {
    ...
    qrCodeUrl: generatePartnerQrCode(`${baseUrl}/book?partner=EST-SUNNYVALE-01`, "SUNNYVALE ESTATE", "HHP-PTR-83921", "EST-SUNNYVALE-01"),
    status: "ACTIVE",
    tierLevel: "GOLD",
  ...
  const realtorPartner: PartnerProfile = {
    ...
    qrCodeUrl: generatePartnerQrCode(`${baseUrl}/book?partner=PTR-APEX-77`, "APEX LUXURY HOMES", "HHP-PTR-77002", "PTR-APEX-77"),
    status: "ACTIVE",
    tierLevel: "SILVER",
